...
```bash
ls /mnt/tigerfs/users/alice_at_co.com/.history/USER.md/          # all versions
cat /mnt/tigerfs/users/alice_at_co.com/.history/USER.md/2026-03-23T150000Z  # specific version
```

Restore any file to any point in time:

```bash
cat /mnt/tigerfs/users/alice_at_co.com/.history/USER.md/[timestamp] > /mnt/tigerfs/users/alice_at_co.com/USER.md
```

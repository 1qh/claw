...
All shared config lives in [TigerFS](../architecture/data.md) at `/mnt/tigerfs/config/`. Since TigerFS is backed by TimescaleDB, a write to any file is instantly visible to all gateways reading from the same mount. ACID-guaranteed.
